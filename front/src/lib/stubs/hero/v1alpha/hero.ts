...
/**
 * @generated from protobuf message hero.v1alpha.FightRequest
 */
export interface FightRequest {
    ...
    id: number;
    /**
     * @generated from protobuf field: int32 id2 = 2;
     */
    id2: number;
}
/**
 * @generated from protobuf message hero.v1alpha.FightResponse
 */
...
class FightRequest$Type extends MessageType<FightRequest> {
    constructor() {
        super("hero.v1alpha.FightRequest", [
            { no: 1, name: "id", kind: "scalar", T: 5 /*ScalarType.INT32*/ },
            { no: 2, name: "id2", kind: "scalar", T: 5 /*ScalarType.INT32*/ }
        ]);
    }
    create(value?: PartialMessage<FightRequest>): FightRequest {
        const message = { id: 0, id2: 0 };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
    ...
    internalBinaryWrite(message: FightRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* int32 id2 = 2; */
        if (message.id2 !== 0)
            writer.tag(2, WireType.Varint).int32(message.id2);
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
/**
 * @generated MessageType for protobuf message hero.v1alpha.FightResponse
 */
